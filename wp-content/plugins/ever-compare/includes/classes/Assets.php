    ...
    public function get_scripts() {
        ...
        $script_list = [
            'evercompare-admin' => [
                ...
                'version' => filemtime( EVERCOMPARE_PATH . '/assets/js/admin.js' ),
                'deps'    => [ 'jquery' ]
            ],
            'evercompare-frontend' => [
                'src'     => EVERCOMPARE_ASSETS . '/js/frontend'.$this->suffix.'.js',
                'version' => filemtime( EVERCOMPARE_PATH . '/assets/js/frontend.js' ),
                'deps'    => [ 'jquery' ]
            ],
        ];
    ...
    public function get_styles() {
        ...
        $style_list = [
            'evercompare-admin' => [
                ...
                'version' => filemtime( EVERCOMPARE_PATH . '/assets/css/admin.css' ),
            ],
            'evercompare-frontend' => [
                'src'     => EVERCOMPARE_ASSETS . '/css/frontend'.$this->suffix.'.css',
                'version' => filemtime( EVERCOMPARE_PATH . '/assets/css/frontend.css' ),
            ],
        ];
