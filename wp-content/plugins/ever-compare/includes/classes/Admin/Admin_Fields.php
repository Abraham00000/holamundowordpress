    ...
    protected function fields_settings() {
        ...
        $settings_fields = array(
            ...
            'ever_compare_table_settings_tabs' => array(
                ...
                array(
                    'name'    => 'enable_shareable_link_message',
                    'headding'=> wp_kses_post('e.g: your-site.com/your-selected-ever-compare-page/?evcompare=24,12,21'),
                    'type'    => 'title',
                    'size'    => 'margin_0 regular',
                    'class' => 'depend_enable_shareable_link element_section_title_area message-info',
                ),
