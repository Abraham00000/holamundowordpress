...
class Shortcode {
    ...
    public function get_icon( $type = '' ){
        ...
        $default_icon   = file_get_contents( EVERCOMPARE_ASSETS .'/images/icon.svg' );
        $default_loader = '<span class="ever-compare-loader">'.file_get_contents( EVERCOMPARE_ASSETS .'/images/loading.svg' ).'</span>';
