    ...
    */
    ...
    public function admin_notice_missing_woocommerce_plugin(){
        ...
        if( $this->is_plugins_active( $woocommerce ) ) {
            ...
            $message = sprintf( __( '%1$sHT Compare%2$s requires %1$s"WooCommerce"%2$s plugin to be installed and activated. Please install WooCommerce to continue.', 'wishsuite' ), '<strong>', '</strong>' );
